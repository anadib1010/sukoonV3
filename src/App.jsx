...
import { Stillness } from './features/games/Stillness'; // Make sure this file exists!
...
export default function App() {
  ...
  // List of all valid tabs to prevent the fallback screen from showing up incorrectly
  const validTabs = [
