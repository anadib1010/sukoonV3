...
// 1. We keep your original imports, but add our new LEGO bricks
...
// 2. Changed the name here from MorePage to ExploreMore
export function ExploreMore({ setTab, goBack, T, lang, setThemeKey }) {
  ...
  const s = {
    ...
    sectionLabel: {
      fontSize: 10,
      color: T.textSoft || "rgba(255,255,255,0.5)", // Protected against undefined T.muted
      letterSpacing: 2,
    ...
    toolDesc:  { fontSize: 11, color: T.textSoft || "rgba(255,255,255,0.5)", textAlign: "center", lineHeight: 1.2, opacity: 0.7 },
    ...
    crisisBtn: {
      ...
      opacity: visible ? 1 : 0,
      // 4. THE BUG FIX: I combined your transition2 into the main transition line right here!
      transition: "background 0.2s, opacity 0.6s ease 0.2s", 
    },

    crisisTitle: { fontSize: 14, color: T.text, fontWeight: 600, lineHeight: 1.2 },
    crisisDesc:  { fontSize: 11, color: T.textSoft || "rgba(255,255,255,0.5)", lineHeight: 1.2, opacity: 0.8 },
  ...
  return (
    <div style={s.page}>
      ...
      {/* 3. Snapped in your BrandHeader here! */}
      <BrandHeader T={T} />
      ...
      {/* 4. Snapped in your BackButton here! */}
      <BackButton setTab={setTab} destination="more" T={T} lang={lang} />
