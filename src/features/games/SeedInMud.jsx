...
export function SeedInMud({ setTab, T, lang }) {
  ...
  let stageIcon = "🌱"; 
  // This is the magic math that makes it grow from 40px up to the exact width of the screen!
  ...
  if (growth >= 100) {
    ...
    // When fully grown, it takes up the whole screen minus 30px (15px padding on each side)
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        opacity: growth >= 100 ? 0 : 1, transition: 'opacity 2s ease', pointerEvents: 'none', padding: '0 20px'
      }}>
        <h2 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '28px', fontWeight: 300, color: isRushing ? '#ff8888' : 'rgba(255,255,255,0.8)', transition: 'color 0.5s ease', margin: '0 0 10px 0' }}>
      ...
      <div style={{
        ...
        pointerEvents: 'none',
        lineHeight: 1, // Keeps the giant emoji perfectly centered
      ...
      <div style={{
        position: 'absolute', bottom: '15%', opacity: growth >= 100 ? 1 : 0,
        transition: 'opacity 3s ease', pointerEvents: 'none', textAlign: 'center', padding: "0 20px"
      }}>
        <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '20px', color: 'rgba(255, 200, 220, 0.9)', fontStyle: 'italic' }}>
