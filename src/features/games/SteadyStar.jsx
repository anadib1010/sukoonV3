  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute', top: 20, left: 20 }}>
        <button onClick={() => setTab('stillness')} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.3)', cursor: 'pointer' }}>
          ← {hi ? 'वापस' : 'Back'}
        </button>
      </div>
      ...
      <p style={{
        ...
        {hi ? "पूरी तरह स्थिर रहें" : "Be perfectly still"}
      </p>
    </div>
  );
}