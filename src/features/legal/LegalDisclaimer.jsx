...
export function LegalDisclaimer({ setTab, goBack, T, lang }) {
  ...
  const SECTIONS = [
    {
      ...
      paras: [
        {
          en: "J Sukoon is a general-purpose digital wellbeing application offering guided exercises, journaling prompts, and reflective content.",
          hi: "J Sukoon एक सामान्य डिजिटल वेलबीइंग ऐप है जो गाइडेड अभ्यास, जर्नलिंग प्रॉम्प्ट और चिंतन सामग्री प्रदान करता है।",
        },
        {
    ...
    },
    {
      ...
      paras: [
        {
          en: "Certain interactive features within J Sukoon, including reflective responses, are powered by Artificial Intelligence (AI) algorithms.",
          hi: "J Sukoon की कुछ इंटरैक्टिव सुविधाएं, जिनमें चिंतन प्रतिक्रियाएं शामिल हैं, आर्टिफिशियल इंटेलिजेंस (AI) एल्गोरिदम द्वारा संचालित हैं।",
        },
        {
    ...
    },
    {
      ...
      paras: [
        {
          en: "J Sukoon stores your personal journal entries, mood logs, reflections, and session data securely on Supabase — a trusted cloud platform protected by row-level security and encrypted connections.",
          hi: "J Sukoon आपकी जर्नल प्रविष्टियां, मूड लॉग, चिंतन और सत्र डेटा Supabase पर सुरक्षित रूप से संग्रहीत करता है — एक विश्वसनीय क्लाउड प्लेटफ़ॉर्म जो row-level security और एन्क्रिप्टेड कनेक्शन द्वारा सुरक्षित है।",
        },
        {
          en: "J Sukoon uses PostHog to collect anonymous usage analytics — pages visited, features used, and in-app actions such as completing a meditation. This data is tied to your account ID and used solely to improve the app. Your journal entries, personal writing, and thoughts are never recorded in analytics.",
          hi: "J Sukoon बेहतर बनाने के लिए PostHog एनालिटिक्स का उपयोग करता है — देखे गए पेज, उपयोग की गई सुविधाएं और इन-ऐप क्रियाएं जैसे ध्यान पूरा करना। यह डेटा आपके खाता ID से जुड़ा है और केवल ऐप सुधार के लिए उपयोग किया जाता है। आपकी जर्नल प्रविष्टियां और व्यक्तिगत लेखन कभी रिकॉर्ड नहीं किया जाता।",
        },
        {
    ...
    },
    {
      ...
      paras: [
        {
          en: "To the maximum extent permitted by applicable law, the developer of J Sukoon disclaims all liability for any direct, indirect, incidental, or consequential damages arising out of your use or inability to use this application.",
          hi: "लागू कानून द्वारा अनुमत अधिकतम सीमा तक, J Sukoon के डेवलपर इस ऐप के उपयोग या उपयोग में असमर्थता से उत्पन्न किसी भी प्रत्यक्ष, अप्रत्यक्ष, आकस्मिक या परिणामी नुकसान के लिए सभी दायित्व को अस्वीकार करते हैं।",
        },
        {
    ...
    { // 👈 Now Section 5 starts as its own clean object
      ...
      paras: [
        ...
        {
          en: "J Sukoon is a fan-led community project. It is not officially affiliated with, endorsed by, or associated with any K-pop labels (such as HYBE, SM, YG, JYP) or specific musical artists.",
          hi: "J Sukoon एक प्रशंसक-आधारित सामुदायिक प्रोजेक्ट है। यह किसी भी K-pop लेबल (जैसे HYBE, SM, YG, JYP) या कलाकारों से आधिकारिक रूप से जुड़ा नहीं है।",
        },
      ],
    },
  ];
  ...
  const SUMMARY = [
    { en: "J Sukoon listens, but does not diagnose.",  hi: "J Sukoon सुनता है, लेकिन निदान नहीं करता।" },
      ...
      <div className="scroll-area fade-up" style={s.scroll}>
        <div style={s.inner}>
          ...
          <div style={s.redBox}>
            ...
            <p style={s.redText}>
              J Sukoon <strong style={s.redStrong}>{hi ? "संकट हस्तक्षेप सेवा नहीं है" : "is not a crisis intervention service"}</strong>. {hi ? "यह थेरेपी, परामर्श, मनोरोग निदान या आपातकालीन चिकित्सा सहायता प्रदान नहीं करता।" : "It does not provide therapy, counselling, psychiatric diagnosis, or emergency medical support."}
            </p>
            <p style={s.redText}>
          ...
          {/* Sections */}
          <div style={s.body}>
            <p style={s.termsLabel}>J Sukoon — {hi ? "पूर्ण नियम" : "Full Terms"}</p>
