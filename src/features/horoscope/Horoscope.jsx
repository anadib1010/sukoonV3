          ...
          <div>
            ...
            <div style={s.row}>
              ...
              <select style={s.select} value={form.year} onChange={set('year')}>
                ...
                {Array.from({ length:100 }, (_,i) => { const y = 2026-i; return <option key={y} value={y}>{y}</option>; })}
              </select>
            </div>
      ...
      {citySuggestions.map((c, i) => (
        ...
        >
          {c.label}
            ...
            <div style={{ background:'#FDF6EC', border:'1px solid #C17B2B30', borderRadius:'10px', padding:'12px 16px', marginBottom:'20px' }}>
              <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:'11px', color:'#8B5E3C', lineHeight:1.7, margin:0, textAlign:'center' }}>
                ⚠️ This horoscope is generated by AI using classical Vedic astrology rules. While it may be fairly accurate, please do not make major life decisions — medical, financial, legal or personal — based solely on this reading. It is intended for reflection and guidance only.
              </p>
            </div>
