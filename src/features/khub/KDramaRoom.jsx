...
const spamLimiter3 = new SpamLimiter(5, 10);
...
{!currentUser && (
          <div style={{ width: '100%', textAlign: 'center', padding: '10px 0 4px' }}>
            <button onClick={() => setTab('home')} style={{ background: '#FAD0C422', border: '1px solid #FAD0C444', borderRadius: '20px', padding: '10px 20px', color: '#c0956a', fontSize: '13px', fontWeight: 600, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif" }}>
