      ...
      <div style={s.inputArea}>
        {!currentUser && (
          <div style={{ width: '100%', textAlign: 'center', padding: '10px 0 4px' }}>
            <button
              onClick={() => setTab('home')}
              style={{ background: `${c}22`, border: `1px solid ${c}44`, borderRadius: '20px', padding: '10px 20px', color: c, fontSize: '13px', fontWeight: 600, cursor: 'pointer', fontFamily: "'DM Sans', sans-serif" }}
            >
